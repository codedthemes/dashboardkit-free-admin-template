...
function floatchart() {
  (function () {
    ...
    chart.render();
    chartInstances['total-line-1-chart'] = chart;
    ...
    chart.render();
    chartInstances['total-line-2-chart'] = chart;
    ...
    chart.render();
    chartInstances['total-line-3-chart'] = chart;
    ...
    chart.render();
    chartInstances['cashflow-bar-chart'] = chart;
    ...
    chart.render();
    chartInstances['category-donut-chart'] = chart;
  })();
}
